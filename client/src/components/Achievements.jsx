...
const achievementsData = [
  { icon: <Code className="w-8 h-8 text-blue-400" />, count: "200+", text: "DSA Problems Solved", date: "Ongoing", description: "Solved 200+ problems on LeetCode and other platforms with focus on algorithm optimization.", credentialLink: "https://leetcode.com/u/Ashutosh4789/", bgImage: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=2070&auto=format&fit=crop" },
  { icon: <Trophy className="w-8 h-8 text-yellow-400" />, count: "1st", text: "Zerodha Varsity Quiz", date: "2025", description: "Secured first position in the University Level Zerodha Varsity Quiz.", credentialLink: "https://drive.google.com/file/d/1XH_3VKbi_nYO91AAcSBKvHk2hqygz65o/view", bgImage: "https://images.unsplash.com/photo-1579548122080-c35fd6820ecb?q=80&w=2070&auto=format&fit=crop" },
  { icon: <Star className="w-8 h-8 text-purple-400" />, count: "Special", text: "Vikas Mela 2025", date: "2025", description: "Felicitated at Vikas Mela 2025 by the Government of Odisha for academic and technical excellence.", credentialLink: "https://drive.google.com/file/d/1yJGnQGRYrFe1ED2EB2_okztTh3AaetTJ/view", bgImage: "https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?q=80&w=2070&auto=format&fit=crop" }
];
